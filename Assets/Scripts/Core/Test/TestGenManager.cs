...
namespace Test
{
    ...
    public class TestGenManager : MonoBehaviour
    {
        [Header("References")]
        ...
        {
            population = new TestNNet[initialPopulation];
        ...
        private void FillPopulationWithRandomValues (TestNNet[] newPopulation, int startingIndex)
        {
            while (startingIndex < initialPopulation)
            {
                newPopulation[startingIndex] = new TestNNet();
                newPopulation[startingIndex].Initialize(controller.LAYERS, controller.NEURONS);
                startingIndex++;
            }
        }

        public void Death (float fitness, TestNNet network)
        {
        ...
        private void RePopulate()
        {
            ...
            TestNNet[] newPopulation = PickBestPopulation();
        ...
        private void Mutate (TestNNet[] newPopulation)
        {
        ...
        private void Crossover (TestNNet[] newPopulation)
        {
            for (int i = 0; i < numberToCrossover; i+=2)
            {
                ...
                TestNNet Child1 = new TestNNet();
                TestNNet Child2 = new TestNNet();
        ...
        private TestNNet[] PickBestPopulation()
        {

            TestNNet[] newPopulation = new TestNNet[initialPopulation];
