    ...
    public class TestNNet
    {
        ...
        public void Initialize (int hiddenLayerCount, int hiddenNeuronCount)
        {
            ...
            for (int i = 0; i < hiddenLayerCount + 1; i++)
            {
                ...
                if (i == 0)
                {
                    Matrix<float> inputToH1 = Matrix<float>.Build.Dense(NUMBER_OF_INPUTS, hiddenNeuronCount);
        ...
        public TestNNet InitializeCopy (int hiddenLayerCount, int hiddenNeuronCount)
        {
            TestNNet n = new TestNNet();
